...
import com.zkb.gaodemap.util.ErrorInfo;
import com.zkb.gaodemap.util.TTSController;
...
public abstract class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
...
//        mAMapNavi.stopNavi();
    ...
    @Override
    public void onGetNavigationText(int type, final String text) {
        //播报类型和播报文字回调
        //  mTtsManager.startSpeaking("播报类型和播报文字回调");
    ...
    public static void sendMsg(String msg,String ip) {
        ...
        try {
            ...
            mSocket = new Socket(ip, 4700);
            //向本机的4700端口发出客户请求
            os = new PrintWriter(mSocket.getOutputStream());
            //由Socket对象得到输入流，并构造相应的BufferedReader对象
            String readline;
            readline =  msg; //从系统标准输入读入一字符串
            os.println(readline);
